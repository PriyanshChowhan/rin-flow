          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Instant CIBIL-based scoring with detailed risk breakdowns, pros, cons, and officer recommendations per loan."
              },
              {
                title: "End-to-End Loan Tracking",
                description: "Real-time status visibility for applicants and officers — from submission through approval or rejection."
              }
            ].map((feature, index) => (
